...
5. **Badge**: Version 1.4.7, Platform icons (macOS, Windows)
...
- [ ] Set up GitHub Actions for releases (optional)
...
- Windows: 运行 EXE 安装器，按提示完成安装

**系统要求 / Requirements:**
- macOS: macOS 11.0+ (Apple Silicon)
- Windows: Windows 10/11 (x64 或 x86)
```
