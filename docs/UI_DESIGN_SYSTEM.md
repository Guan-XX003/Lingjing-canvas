...
- 危险操作：所有删除、移除、清空、重置等破坏性动作固定使用红色体系；常驻工具按钮使用浅红底、红边、红字，确认删除等最终破坏动作才使用实心红。
...
- 危险按钮：默认使用 `--wj-danger-control-*` 的浅红底、红边、红字，任何主题下不随主题色改变；只在确认弹窗主按钮等最终破坏动作中使用 `--wj-danger-bg` 实心红。
