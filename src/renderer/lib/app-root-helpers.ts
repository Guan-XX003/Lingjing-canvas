...
export const wanjuanI18n = {
      "zh-TW": {
        ...
        "1.4.0：新增邮箱账号、本机安全凭据存储、企业局域网网关和成员配额管理；完善全局配置切换与卸载清理，并修复主网关管理态丢失和应用内版本显示不一致。": "1.4.0：新增信箱帳號、本機安全憑證儲存、企業區域網路閘道和成員配額管理；完善全域配置切換與解除安裝清理，並修復主閘道管理狀態遺失和 App 內版本顯示不一致。",
      ...
      "en-US": {
        ...
        "1.4.0：新增邮箱账号、本机安全凭据存储、企业局域网网关和成员配额管理；完善全局配置切换与卸载清理，并修复主网关管理态丢失和应用内版本显示不一致。": "1.4.0: Added email accounts, secure local credential storage, enterprise LAN gateways, and member quotas; improved configuration switching and uninstall cleanup, and fixed lost gateway-owner management state and inconsistent in-app version display.",
