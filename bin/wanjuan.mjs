...
try {
  ...
  else if (command === "tianji" && subcommand === "generate") print(await wanjuanRequest("POST", "/v1/tianji/generate", { prompt: option(args, "--prompt"), model: option(args, "--model"), resolution: option(args, "--resolution", "720p"), duration: option(args, "--duration", "5"), aspectRatio: option(args, "--ratio", "16:9"), mode: option(args, "--mode", "text-to-video"), images: options(args, "--image"), videos: options(args, "--video"), audios: options(args, "--audio") }));
