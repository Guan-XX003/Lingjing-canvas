// 列出 WanJuanAppCanvas return 里的「cond && jsx(...)」大块，并算每块的 props 数（组件作用域自由变量）。
...
let comp = null;
(function f(n) { if (ts.isFunctionDeclaration(n) && n.name?.text === 'WanJuanAppCanvas') comp = n; ts.forEachChild(n, f); })(sf);
